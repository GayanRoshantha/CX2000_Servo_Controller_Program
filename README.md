...
# Overview:
This project demonstrates the integration and control of a CX2000 series servo motor using a Beckhoff CX8190 Embedded PC with TwinCAT 3 and the TC2_MC2 motion control library.
...
# Features:
- Servo axis configuration and commissioning in TwinCAT 3
